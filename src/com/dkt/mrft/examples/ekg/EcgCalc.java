...
public class EcgCalc {
    ...
    private final double[] ti = new double[6];  /* ti converted in radians             */
    private final double[] ai = new double[6];  /* new calculated a                    */
    private final double[] bi = new double[6];  /* new calculated b                    */        

    private final int Necg = 0;                 /*  Number of ECG outputs              */
    private final int mstate = 3;               /*  System state space dimension       */
    private final double xinitial = 1.0;        /*  Initial x co-ordinate value        */
    private final double yinitial = 0.0;        /*  Initial y co-ordinate value        */
    private final double zinitial = 0.04;       /*  Initial z co-ordinate value        */
    private long rseed; 
    private double h; 
