...
public class Spline {
    ...
    private Spline(double[] x, double[] y, double[] m) {
        mX = x;
        mY = y;
        mM = m;
    }
     ...
     * @return
     *
     * @throws IllegalArgumentException if the X or Y arrays are null, have different lengths or
     * have fewer than 2 values.
     */
    public static Spline createCubicSpline(double[] x, double[] y) {
        ...
        final double[] d = new double[n - 1]; // could optimize this out
    ...
    public double interpolate(double x) {
        ...
        final double h = mX[i + 1] - mX[i];
        final double t = (x - mX[i]) / h;
